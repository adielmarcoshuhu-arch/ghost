...
$access_token = 'EAAKx7SpqamUBPmW91jJnmAIqKirNrtc85lmDZBcEnwaDS2DyH8SmBjefq9XfMR0LoGwSRnYXtub0jfxm91ql7lcAp7qEL3r4u7iyJ4IYZCa3SDj0zOZCUq4nQag4pLZCsaZAtB6nc1AnZCleaK6RoRsTXYAyxe89IabTBtYAR41TZBRf6SokQhRLBOyUfmpvvNH';

// Construir parâmetros para a API do Facebook
$api_params = [
    'search_terms' => $search_term,
    'ad_reached_countries' => [$country],
    'fields' => 'id,page_name,ad_creative_body,ad_snapshot_url,ad_creative_link_description,start_date,ad_delivery_start_time,ad_delivery_stop_time,platforms,ad_creative_call_to_action_type',
    'limit' => 50,
...
$api_url = 'https://graph.facebook.com/v19.0/ads_archive?' . http_build_query($api_params);
...
function passesFilters($ad, $platforms, $language, $technology, $checkout, $player, $button, $media_type, $hot_period_min) {
    ...
    if ($hot_period_min > 0 && isset($ad['start_date'])) {
...
function enrichAdData($ad) {
    ...
    if (isset($ad['start_date'])) {
        $ad['formatted_date'] = date('d M Y', strtotime($ad['start_date']));
    }
